...
public class MenuScreen extends AbstractScreen {
    ...
    public void show() {
        ...
        btnNewGame.setPosition(ScreenManager.HALF_SCREEN_WIDTH - btnNewGame.getWidth()/2, 310);
        btnOptions.setPosition(ScreenManager.HALF_SCREEN_WIDTH - btnOptions.getWidth()/2,210);
    ...
    public void render(float delta) {
        ...
        font72.draw(batch, "Star Game 2019", 0, ScreenManager.HALF_SCREEN_HEIGHT, ScreenManager.SCREEN_WIDTH, Align.center, false);
        batch.end();
        stage.draw();
    }
